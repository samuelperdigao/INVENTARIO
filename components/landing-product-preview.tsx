      ...
      <div className={styles.workflowPreview}>
        <div className={styles.entryPreview}>
          ...
          <div className={styles.entryPreviewBody}>
            ...
            <div className={styles.previewEntryForm}><div className={styles.previewFieldRow}><div><small>Lado</small><b>DE</b></div><div><small>Vão</small><b>15</b></div><div><small>Camada</small><b>1</b></div></div><div className={styles.previewFieldRow}><div><small>Lote</small><b>123456</b></div><div><small>Quantidade</small><b>24 peças</b></div></div><div className={styles.previewAdd}><Icon name="plus" size={15} />Adicionar lançamento</div></div>
            <div className={styles.previewTable}><div className={styles.previewTableTabs}><b>Lado DE (24)</b><span>Lado EF (24)</span></div><strong>Vão 15 <small>8 itens</small></strong><div className={styles.previewTableHead}><span>Lote</span><span>Camada</span><span>Quantidade</span><span>Ações</span></div>{[["123456", "1", "24"], ["123457", "1", "18"], ["123458", "2", "12"]].map((row) => <div className={styles.previewTableRow} key={row[0]}><span>{row[0]}</span><span>{row[1]}</span><span>{row[2]}</span><span>✎　▣</span></div>)}</div>
          </div>
        </div>
