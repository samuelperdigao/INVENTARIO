...
- Migration `0007_recovery_pin`: hash do NP, contador de falhas e instante de bloqueio temporário. A `0005_access_sharing` continua responsável pela participação e autoria do histórico.
- Contas anteriores à `0007` recebem uma etapa autenticada obrigatória para configurar e confirmar o NP no próximo login.
